    ...
    <div v-if="showPersonalInfoDialog" class="dialog-overlay" @click="showPersonalInfoDialog = false">
      <div class="dialog-box" @click.stop>
        ...
        <div class="info-row">
          ...
          <input v-model="personalInfo.gender" class="info-input" />
        </div>
        <div class="info-row">
          <span class="info-label">患者ID：</span>
          <input v-model="personalInfo.patientId" class="info-input" disabled />
        </div>
        <div class="info-row">
          <span class="info-label">年龄：</span>
          <input v-model="personalInfo.age" class="info-input" />
        </div>
...
const notifications = ref([
  { id: 1, message: '您的预约申请已通过，请按时到院检查', time: '10分钟前', read: false },
  { id: 2, message: '您的检查报告已出，请查看详情', time: '1小时前', read: false },
  { id: 3, message: '温馨提示：检查前请空腹8小时以上', time: '3小时前', read: true }
]);
