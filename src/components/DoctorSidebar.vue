...
.sidebar-section {
  ...
  position: fixed; /* 改为 fixed 定位，始终占据左侧 */
  left: 0;
  top: 0;
  bottom: 0; /* 添加 bottom: 0，让侧边栏自动延伸到底部 */
  width: 5.31rem;
...
.sidebar-icon.active {
  opacity: 1;
  filter: drop-shadow(0rem 0.2rem 0.4rem #00baad) brightness(1.1);
  transform: scale(1.1);
}

/* 第一个图标更大，所以激活时缩放比例要小一些，保持视觉一致 */
