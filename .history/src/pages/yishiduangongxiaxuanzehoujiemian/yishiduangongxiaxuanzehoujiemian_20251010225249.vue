<script setup>
  ...
  const searchResults = ref([
    {
      id: '2025521-ZYX-01',
      image: '/57ad46bf3cb15949571b19f64edf7387.png',
      patientName: '张医学',
      age: 65,
      diagnosis: '胃炎'
    },
    {
      id: '2025521-CYX-01',
      image: '/c385c6b449cd51d4aa579cc2b1d82984.png',
      patientName: '陈医学',
      age: 58,
      diagnosis: '胃溃疡'
    }
...
<template>
  <div class="flex-col justify-start relative page">
    ...
    <div class="flex-row section_4 pos_4">
      <span class="self-start text_3">数据筛选</span>
      <div class="flex-row flex-1 self-center group_2">
        <div class="flex-row flex-1">
          <div class="flex-row justify-end items-center flex-1">
          ...
          <div class="ml-30 flex-row items-center group_3">
            ...
            <span class="font_2 text_7">主治医师：</span>
          </div>
        </div>
        <div class="ml-30 flex-row items-center group_4">
          <input v-model="filterForm.date" type="date" class="relative section_5 filter-input" />
          <span class="font_2 text_9">日期：</span>
        </div>
      </div>
      <div class="flex-row self-center group_5">
