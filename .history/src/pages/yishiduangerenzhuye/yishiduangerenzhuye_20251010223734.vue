<script setup>
  ...
  const recentViews = ref([
    { id: '250619162', name: '黄仁丰_250816015.mp4', date: '2023-10-27', type: '视频' },
    { id: '250705047', name: '郑廷洲_250705123.mp4', date: '2023-10-26', type: '视频' },
    { id: '250605040', name: '马万华_250605108.mp4', date: '2023-10-25', type: '视频' }
  ]);

  // 我的收藏数据
  const myFavorites = ref([
    { id: 'FAV001', name: '胃炎案例-张医学', date: '2023-10-20', type: '病例' },
    { id: 'FAV002', name: '胃溃疡案例-陈医学', date: '2023-10-18', type: '病例' }
  ]);

  // 我的图像数据
  const myImages = ref([
    { id: 'IMG001', name: '胃部超声图像1', date: '2023-10-27', type: '图像' },
    { id: 'IMG002', name: '胃部超声图像2', date: '2023-10-26', type: '图像' },
    { id: 'IMG003', name: '胃部超声图像3', date: '2023-10-25', type: '图像' }
  ]);
